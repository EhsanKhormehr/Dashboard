      ...
      <section >
        <div className="rounded-2xl bg-primary px-8 py-8">
          <div className="grid grid-cols-1 gap-6 lg:grid-cols-[1.2fr_0.8fr] lg:items-center">
            <div>
              <h2 className="text-2xl font-bold text-surface">Stay Updated</h2>
              <p className="mt-2 max-w-md text-sm leading-6 text-surface/80">
            ...
            <form className="flex w-full flex-col gap-3 sm:flex-row lg:justify-end">
              <Input
                ...
                className="h-12 w-full rounded-xl bg-surface px-4 text-sm sm:max-w-sm"
              />
              <Button
                type="submit"
                className="h-12 rounded-xl bg-dashboard-text hover:bg-dashboard-text cursor-pointer px-6 text-sm font-semibold text-surface"
              >
                Subscribe
              </Button>
            </form>
