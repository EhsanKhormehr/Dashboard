...
const HomePageCampaignBanner = () => {
  return (
    <div className="relative h-[450px] bg-gradient-to-r from-zinc-700 to-neutral-900">
      ...
      <div className="flex flex-col items-center justify-center z-10 relative h-full">
        ...
        <Link
          href={"/"}
          className="text-white py-3 inline-block mt-10 text-sm px-14 border font-semibold rounded-sm"
        >
          Shop Now
        </Link>
      </div>
